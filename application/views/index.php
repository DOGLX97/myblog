...
<div id="OSC_Screen"><!-- #BeginLibraryItem "/Library/OSC_Banner.lbi" -->
    <div id="OSC_Banner">
        <div id="OSC_Slogon">Ares's Blog</div>
        <div id="OSC_Channels">
            <ul>
    ...
    <div id="OSC_Topbar">
        <div id="VisitorInfo">
            当前访客身份：<?php echo $loginedUser->username;?>
    ...
    <div id="OSC_Content">
        ...
        <div class="BlogList">
            <ul>
                ...
                <li class="Blog">
                    <h2><a href="viewPost_comment.htm"></a></h2>

                    <div class="outline">
                        <span class="time">发表于 </span>
                        <span class="catalog">分类: <a href="#">type_name</a></span>
